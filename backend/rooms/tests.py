...
#         self.assertIn("testuser2", response1["user1"])
#         self.assertIn("testuser3", response1["user2"])
#         self.assertIn("testuser4", response1["user3"])
#
#         response2 = await communicator2.receive_json_from()
#         print(response2)
#         self.assertIn("testuser1", response2["user0"])
#         self.assertIn("testuser2", response2["user1"])
#         self.assertIn("testuser3", response2["user2"])
#         self.assertIn("testuser4", response2["user3"])
#
#         response3 = await communicator3.receive_json_from()
#         # print(response3)
...
#         self.assertIn("testuser4", response3["user3"])
#
#         response4 = await communicator4.receive_json_from()
#         # print(response4)
